...
export default {
  ...
  updated() {
    ...
    this.$firebase
      .database()
      .ref()
      .child('usuarios/' + uid + '/user/projeto/' + key + '/mapausuario/')
      .update({ estagio: this.listaEstagio })
  },
  methods: {
    onAddPremissa() {
      var key = this.myProject.key
      ...
      var newPostKey = this.$firebase
        .database()
        .ref()
        .child('usuarios/' + uid + '/user/projeto/' + key + '/mapausuario/premissa/')
        .push().key
      var updates = {}
      var key = this.myProject.key
      var uid = this.user.uid
      ...
      return this.$firebase
        ...
        .then(
          this.$firebase
            .database()
            .ref('usuarios/' + uid + '/user/projeto/' + key + '/mapausuario/premissa/' + keyPremissa)
            .update({ key: keyPremissa })
        )
    ...
    onOkpremissa() {
      ...
      if (this.listaMyPremissas.length > 1) {
        this.$firebase
          .database()
          .ref()
          .child('usuarios/' + uid + '/user/projeto/' + key + '/mapausuario/premissa/' + keyitem)
          .remove()
    ...
    onAddoportunidade() {
      ...
      var newPostKey = this.$firebase
        .database()
        .ref()
        .child('usuarios/' + uid + '/user/projeto/' + key + '/mapausuario/oportunidade')
        .push().key
      var updates = {}
      var key = this.myProject.key
      var uid = this.user.uid
      ...
      return this.$firebase
        ...
        .then(
          this.$firebase
            .database()
            .ref('usuarios/' + uid + '/user/projeto/' + key + '/mapausuario/oportunidade/' + keyOportunidade)
            .update({ key: keyOportunidade })
        )
        .catch(function(error) {
          // [START onfailure]
          console.error('Upload failed:', error)
    ...
    onAddestagio() {
      ...
      var newPostKey = this.$firebase
        .database()
        .ref()
        .child('usuarios/' + uid + '/user/projeto/' + key + '/mapausuario/estagio')
        .push().key
      var updates = {}
      var key = this.myProject.key
      var uid = this.user.uid
      ...
      return this.$firebase
        ...
        .then(
          this.$firebase
            .database()
            .ref('usuarios/' + uid + '/user/projeto/' + key + '/mapausuario/estagio/' + keyEstagio)
            .update({ key: keyEstagio })
        )
        .catch(function(error) {
          // [START onfailure]
          console.error('Upload failed:', error)
    ...
    onOkestagio() {
      ...
      if (this.listaEstagio.length > 1) {
        this.$firebase
          .database()
          .ref()
          .child('usuarios/' + uid + '/user/projeto/' + key + '/mapausuario/estagio/' + keyitem)
          .remove()
    ...
    onOkoportunidade() {
      ...
      if (this.listaOportunidade.length > 1) {
        this.$firebase
          .database()
          .ref()
          .child('usuarios/' + uid + '/user/projeto/' + key + '/mapausuario/oportunidade/' + keyitem)
          .remove()
